...
public class AppointmentShowController {
    ...
    protected void showAppointments() {
        hideAppointments();
        PriorityQueue<Appointment> appointments = mainCtrl.getCalendarService().getAppointments(mainCtrl.getSelectedDate(), mainCtrl.getSelectedMonth(), mainCtrl.getSelectedYear());
